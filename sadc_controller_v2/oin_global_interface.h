...
#define COM_BALANCE_MASK     0b00011000
#define COM_OIN_PLUS1_MASK   0b00001000
#define COM_OIN_PLUS2_MASK   0b00010000
#define COM_COMPORATOR_MASK  0b00000110
#define COM_OIN_MINUS1_MASK  0b00000010
#define COM_OIN_MINUS2_MASK  0b00000100
#define COM_POWER_MASK       0b00000001

#define OIN_DISABLE     0b01000000

// #define OIN_HIGH        OIN_DISABLE | (255 & COM_OIN_PLUS1_MASK) | (255 & COM_COMPORATOR_MASK) | (255 & COM_POWER_MASK)  //OIN + 1, Comporator, Power
#define OIN_HIGH        OIN_DISABLE | (255 & COM_OIN_PLUS1_MASK) | (255 & COM_COMPORATOR_MASK) | (0 & COM_POWER_MASK)  //OIN + 1, Comporator, Ground
...
#define OIN_REQUEST     0b10000000
#define OIN_CHANGE      0b10000001
#define OIN_PING        0b10000010

#define OIN_RESET_ID    0b00000100
#define OIN_TURN_OFF    0b00000000
#define OIN_TURN_ON     0b00000001
